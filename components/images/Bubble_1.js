    ...
    return (
        <figure>
            <svg className={styles.Blob__svg} width="482" height="430" viewBox="0 0 482 430" aria-hidden="true">
                ...
                <clipPath id="Blob__path--blob-1" clipPathUnits="objectBoundingBox"
            ...
            <img src={getImageURI({uri:imageNode.media?.refNode?.path,workspace})}
                    alt="Free template by Free-Template.co" className={classNames("img-fluid",styles.Blob__imgBlob_1)}/>
        </figure>
    )
}
